...
// Важно: прямой WS endpoint (не https, а wss)
const MG_WS_URL = process.env.MG_WS_URL || "wss://mg-s1.retailcrm.pro/api/bot/v1/ws?events=message_new";
...
function connect() {
  console.log("Connecting to MG WS:", MG_WS_URL);
  ...
  ws.on("message", async (data) => {
    ...
    // анти-зацикливание (если вдруг прилетит от бота)
